  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        autoAlignment: w = !0,
        ...y
      } = t, g = _t(m, w, p), v = (n = (i = d.autoPlacement) == null ? void 0 : i.index) != null ? n : 0, x = g[v];
      if (x == null)
        return {};
      const {
        main: b,
        cross: M
      } = ft(x, a, await (u.isRTL == null ? void 0 : u.isRTL(h.floating)));
      if (f !== x)
        return {
          x: s,
          y: l,
      ...
      const H = await Q(e, y), j = [H[_(x)], H[b], H[M]], E = [...(o = (c = d.autoPlacement) == null ? void 0 : c.overflows) != null ? o : [], {
        placement: x,
        overflows: j
      }], B = g[v + 1];
      if (B)
...
function gt(t) {
  return L(t) === "html" ? t : t.assignedSlot || t.parentNode || (U(t) ? t.host : null) || T(t);
}
function st(t) {
...
function zt(t) {
  ...
  for (; n && n !== e; ) {
    ...
    if (o) {
      ...
      n = o, e !== c && (e = c, i = !0);
    } else if (U(n) && n.host && i)
      break;
    n = U(n) && n.host || n.parentNode;
  }
  return e;
}
function Xt(t) {
  let e = gt(t);
  for (U(e) && (e = e.host); P(e) && !["html", "body"].includes(L(e)); ) {
    if (pt(e))
      return e;
    {
...
function Yt(t) {
  ...
  if ((o || !o && i !== "fixed") && ((L(n) !== "body" || H(c)) && (r = q(n)), P(n))) {
    const l = O(n, !0);
...
function wt(t) {
  const e = gt(t);
  return ["html", "body", "#document"].includes(L(e)) ? t.ownerDocument.body : P(e) && H(e) ? e : wt(e);
}
function Y(t, e) {
  var n;
  e === void 0 && (e = []);
  const i = wt(t), o = i === ((n = t.ownerDocument) == null ? void 0 : n.body), c = R(i), r = o ? [c].concat(c.visualViewport || [], H(i) ? i : []) : i, s = e.concat(r);
